...
AIM OF THE PROJECT: THE MODEL WILL LEARN TO PREDICT THE NEXT WORD GIVEN PREVIOUS THREE WORDS
This is why we have to divide the data from 4 * 377550 to 3 * 377550 so that we have a target label represented 
by the 4th row
